...
```json
{
  ...
  "key": "re_CPmkxQmyBQuFswJ7uGpMm1wSeDVRWoJocnyuYcLxQgGG",
...
curl -X GET http://localhost:4111/auth/me \
  -H "Authorization: Bearer re_CPmkxQmyBQuFswJ7uGpMm1wSeDVRWoJocnyuYcLxQgGG"
```
...
API_KEY = "re_CPmkxQmyBQuFswJ7uGpMm1wSeDVRWoJocnyuYcLxQgGG"
...
```typescript
const API_KEY = "re_CPmkxQmyBQuFswJ7uGpMm1wSeDVRWoJocnyuYcLxQgGG";
...
```bash
# .env
REVERSE_ENGINEER_API_KEY=re_CPmkxQmyBQuFswJ7uGpMm1wSeDVRWoJocnyuYcLxQgGG
